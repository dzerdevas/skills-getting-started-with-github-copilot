...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball fundamentals and teamwork through weekly practice",
    ...
    "Drama Club": {
        "description": "Practice acting, improvisation, and prepare for school performances",
